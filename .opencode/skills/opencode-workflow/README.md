...
Place this folder at `.opencode/skills/opencode-workflow/` in any project, then ask
your OpenCode agent to run the opencode-workflow skill:

```
/opencode-workflow
```

Or use a trigger keyword like "opencode-workflow", "setup", "configure", or "bootstrap".
...
6. **Optional extras** — Offers additional optional installations.

## Portability

Copy the entire `.opencode/skills/opencode-workflow/` folder to any project. No
